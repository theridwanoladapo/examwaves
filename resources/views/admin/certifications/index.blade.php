                    ...
                    <div class="dash-wrapsw card border-0 rounded-4 py-4 mb-4">
                        <div class="card-body px-4">
                            <div class="d-sm-flex align-items-center mb-4">
                                <h1 class="h4 text-dark mb-4 mb-sm-0 me-4"><i class="fa-regular fa-user text-primary me-2"></i> Certifications</h1>
                                <div class="d-flex ms-auto">
                                    <a href="{{ route('admin.certifications.create')}}" class="btn btn-md btn-light gray-simple me-3 me-sm-4" wire:navigate>
