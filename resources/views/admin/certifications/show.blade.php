                ...
                <div class="col-xl-9 col-lg-8">
                    ...
                    <div class="dash-wrapsw card py-0 px-lg-5 px-4 pb-4 border-0 rounded-4 mb-4">
                        ...
                        <div class="position-absolute end-0 top-0 mt-5 pt-3 me-4 z-1">
                            <a href="{{ route('admin.certifications.edit', $certification->id) }}" class="btn btn-sm btn-whites fw-medium">Edit Certification</a>
                        </div>
                        <div class="dash-y44 position-relative mb-3">
                            <div class="dash-user-thumb mt-5 pt-2">
                                @if ($certification->image_path)
                                <img src="{{ asset($certification->image_path) }}" class="img-fluid bg-white p-2 border border-3" width="100" alt="IMG">
                                @else
                            ...
                            <div class="dash-y45 row align-items-center justify-content-between gy-3 mt-3">
                                <div class="lios-parts-starts col-sm-7">
                                    <h5 class="m-0">{{ $certification->title }} ({{ $certification->code }}) <i class="fa-solid fa-circle-check fs-sm text-success ms-2"></i></h5>
                                    <p class="text-muted mb-0">Description:</p>
									<p class="m-0 text-dark fw-medium"> {{ $certification->description ? $certification->description : 'Nil' }} </p>
                                </div>
                            </div>
                        </div>
                    </div>
