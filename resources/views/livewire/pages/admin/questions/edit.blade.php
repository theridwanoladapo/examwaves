...
use function Livewire\Volt\{mount, state, updated, usesFileUploads};
...
mount(function () {
    $this->form->setQuestion($this->quiz);

    $this->exam = $this->form->exam_id;
    $this->test = $this->form->test_id;
    $this->certification = $this->form->certification_id;
    ...
    $this->option_a = $this->form->option_a;
    $this->option_b = $this->form->option_b;
    $this->option_c = $this->form->option_c;
    $this->option_d = $this->form->option_d;
    $this->option_e = $this->form->option_e;
    $this->option_f = $this->form->option_f;
    $this->option_g = $this->form->option_g;
    $this->explanation = $this->form->explanation;
});
...
$updateQuestion = function () {
    ...
    return $this->redirectRoute('admin.tests.view', $this->test, navigate: true);
}
?>
...
<div>
    ...
    <div class="dash-wrapsw card border-0 rounded-4 py-4 mb-4">
        <div class="card-headers border-0 py-4 px-4 pb-0 pt-1">
            <h4><i class="fa-solid fa-plus text-primary me-2"></i>Edit Question</h4>
        </div>
